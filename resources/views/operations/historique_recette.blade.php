    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between"
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Recette</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12">
                <div class="card card-animate" style="background-color: #5050ae; color: #ffffff;">
                    <div class="card-body">
                            ...
                            <div class="col-6 col-sm-3">
                                <div class="p-3 border border-dashed border-start-0 border-end-0">
                                    <h5 class="mb-1 text-success"><span class="counter-value"
                                            data-target="{{$sumPrix}}">0</span> FCFA</h5>
                                    <p class="text-muted mb-0">Bénéfice</p>
                                </div>
                            </div>
                            <!--end col-->
                        </div>
                    ...
                    <div class="card-body">
                        <div class=table-responsive>
                            @php
                                ...
                                $recette = DB::table('recette')
                                    ...
                                    ->where(function ($query) use ($search) {
                                        $query
                                            ->where('r_description', 'LIKE', '%' . $search . '%')
                                            ->orWhere('s_recette', 'LIKE', '%' . $search . '%');
                                    }) // Filtrer par nom de projet
                                    ->select('*')
                                    ->paginate(10);
                                $val = $recette->firstItem();
                            @endphp
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-3">
                            ...
                            <table id="table1"
                                ...
                                <tbody>
                                    @forelse ( $recette as $recette)
                                        <tr>
                                            <td data-sort="">{{ $val++ }}</td>
                                            <td data-sort=""> <b>{{ html_entity_decode($recette->s_recette) }}</b>
                                            </td>
                                            <td data-sort=""><small
                                                    class="badge badge-soft-dark">{{ html_entity_decode($recette->r_description) }}</small>
                                            </td>
                                            <td data-sort="">#</td>
                                            <td data-sort=""><small class="badge badge-soft-primary">
                                                    {{ $recette->created_at }}</small> </td>
                                            <td data-sort="">
                            ...
                            {{-- <div class="pagination-container">
                                {{ $recette->links('pagination::bootstrap-4') }}
                            </div> --}}
                        </div>
                    </div>
                </div>
