 ...
 <footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <script>document.write(new Date().getFullYear())</script> © MACOMPTA.
            </div>
            <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                    Design & Develop by Yves Like***
                </div>
            </div>
        </div>
    </div>
...
<div class="btn-info btn-rounded shadow-lg btn btn-icon btn-lg p-2" data-bs-toggle="offcanvas"  id="theme"  onclick="affiche()" aria-controls="theme-settings-offcanvas">
            ...
            <div class="d-flex gap-2 flex-wrap img-switch">
                ...
                <div class="form-check sidebar-setting card-radio">
                    ...
                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                        <img src="{{ url('control/images/sidebar/img-1.jpg') }}" class="avatar-md w-auto object-cover">
                    </label>
                </div>
                ...
                <div class="form-check sidebar-setting card-radio">
                    ...
                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                        <img src="{{ url('control/images/sidebar/img-2.jpg') }}" class="avatar-md w-auto object-cover">
                    </label>
                </div>
                <div class="form-check sidebar-setting card-radio">
                    <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                        <img src="{{ url('control/images/sidebar/img-3.jpg') }}" class="avatar-md w-auto object-cover">
                    </label>
                </div>
                <div class="form-check sidebar-setting card-radio">
                    <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                        <img src="{{ url('control/images/sidebar/img-4.jpg') }}" class="avatar-md w-auto object-cover">
                    </label>
                </div>
            </div>
        </div>
...
<script src="{{ url('control/libs/node-waves/waves.min.js') }}"></script>
...
<!-- apexcharts -->
<script src="{{ url('control/libs/apexcharts/apexcharts.min.js') }}"></script>

<!-- Vector map -->
<script src="{{ url('control/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
<script src="{{ url('control/libs/jsvectormap/maps/world-merc.js') }}"></script>

<!-- Swiper slider js -->
<script src="{{ url('control/libs/swiper/swiper-bundle.min.js') }}"></script>

<!-- Countdown js -->
<script src="{{ url('control/js/pages/coming-soon.init.js') }}"></script>

<!-- Marketplace init -->
<script src="{{ url('control/js/pages/dashboard-nft.init.js') }}"></script>
<!-- Sweet Alerts js -->
<script src="{{ url('control/libs/sweetalert2/sweetalert2.min.js') }}"></script>

<!-- select2 cdn -->
<script src="{{ url('control/others/cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js') }}"></script>

<!-- Sweet alert init js-->
<script src="{{ url('control/js/pages/sweetalerts.init.js') }}"></script>

<!-- App js -->
<script src="{{ url('control/js/app.js') }}"></script>
<script src="{{ url('control/libs/prismjs/prism.js') }}"></script>
